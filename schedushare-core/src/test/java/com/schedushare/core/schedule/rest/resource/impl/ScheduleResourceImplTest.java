...
public class ScheduleResourceImplTest extends Application {

	@Test 
	public void testReturnsErrorWhenScheduleNotFound() {
        ClientResource client = new ClientResource("http://localhost:8118");
        String msg = client.getChild("/schedule/1", ScheduleResource.class).getSchedule();
    ...
    @Override public Restlet createInboundRoot() {
        ...
        router.attach("/schedule/{scheduleId}", ScheduleResourceImpl.class);
        return router;
    }
}
