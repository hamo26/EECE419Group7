...
public class UserResourceImplTest extends Application {

	@Test 
	public void testReturnsErrorWhenUserNotFound() {
        ClientResource client = new ClientResource("http://localhost:8118");
        String msg = client.getChild("/user", UserResource.class).getUser();
        assertEquals(msg, "{\"schedushare-error\":\"User id does not exist\"}");
    }
